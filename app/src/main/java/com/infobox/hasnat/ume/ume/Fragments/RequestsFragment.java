                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()){
                            ...
                            if (requestType.equals("received")){
                                ...
                                /**
                                 * here, "cancelBtn" is INVISIBLE
                                 * NB : for our working purpose, in "acceptBtn" we delete/cancel sent requests,
                                 * that should be "cancelBtn", but for our layout design (Button) we do that.
                                 */

                                cancelBtn.setVisibility(View.INVISIBLE);

                                acceptBtn.setText("Cancel Sent Request");
                                acceptBtn.setPadding(15, 0, 15, 0);
